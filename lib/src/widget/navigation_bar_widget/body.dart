import 'package:classroom_app/src/widget/navigation_bar_widget/navigation_bar_item.dart';
...
class Body extends StatelessWidget {
  ...
  final List<NavigationBarItemWidget> items;
              ...
              return Material(
                ...
                child: InkWell(
                  ...
                  child: Stack(children: <Widget>[
                    Padding(
                      padding: itemPadding - (enablePaddingAnimation ? EdgeInsets.only(right: itemPadding.right * t) : EdgeInsets.zero),
                      child: Row(
                        children: [
                          IconTheme(
                            data: IconThemeData(
                    ...
                    ClipRect(
                      child: SizedBox(
                        ...
                        child: Align(
                          ...
                          widthFactor: t,
                          child: Padding(
                            padding: EdgeInsetsDirectional.only(start: itemPadding.right / 0.63, end: itemPadding.right),
                            child: DefaultTextStyle(
                              style: TextStyle(
                                color: Color.lerp(selectedColor.withOpacity(0.0), selectedColor, t),
                                fontWeight: FontWeight.w600,
                              ),
                              child: CircleAvatar(radius: 2.5, backgroundColor: dotIndicatorColor ?? selectedColor),
                            ),
                          ),
                        ),
                      ),
