...
class LaodingProgressWidget extends StatefulWidget {
  final double size;
  final Color color;

  const LaodingProgressWidget({
    super.key,
    required this.size,
    required this.color,
  });
  ...
  @override
  State<LaodingProgressWidget> createState() => _LaodingProgressWidgetState();
}

class _LaodingProgressWidgetState extends State<LaodingProgressWidget>
